...
//show my gifts
router.get('/my-gifts', middlewareController.verifyToken, giftController.MyGifts);
router.get('/get-my-gifts', middlewareController.verifyToken, giftController.getMyGifts);
router.get('/show-stored-gifts', middlewareController.verifyToken, giftController.showStoredGifts);

router.get('/get-all', middlewareController.verifyToken, giftController.getAll);
router.get('/show-all', middlewareController.verifyToken, giftController.showAll);
...
router.post('/store', middlewareController.verifyToken,giftController.store);
